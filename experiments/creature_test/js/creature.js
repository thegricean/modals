	...
	slides.fish_slider = slide({
	    ...
	    /* trial information for this block
	     (the variable 'stim' will change between each of these values,
	      and for each of these, present_handle will be run.) */
	    present : _.shuffle([
	    	{type: "indirect", evidence: "you see fangs:",color:"",path: "m 224.72087,128.95491 6.81853,-2.25254 c 0.57697,22.03278 -2.82062,45.16585 -7.8363,63.4702 3.19194,-21.68019 6.0638,-45.94478 1.01777,-61.21766 z"},
	    	{type: "direct", evidence: "you see whiskers:",color:"",path: "m 216.12695,132.08879 c -14.29361,23.85879 -34.75106,44.10429 -11.61675,89.90358 m 8.08122,-90.91373 c -30.52433,36.14586 -40.99373,68.74778 -24.74873,111.11677 m 22.72842,-114.14723 c -32.28674,23.34556 -51.60559,60.7522 -38.89087,107.07617"},
	    	{type: "report", evidence: "your frind tells you he saw a pimwit.",path: "" }
	    	//{evidence: "report"}
	    	]),
	    //this gets run only at the beginning of the block
