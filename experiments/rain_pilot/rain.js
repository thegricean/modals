...
[
[
{"sentenceType": "bare", "sentence": "It's raining."},
...
var experiment = {
  ...
  sentenceTypes: new Array(numTrials),
  rainingProbs: new Array(numTrials),
  evidenceRatings: new Array(numTrials),
  ...
  next: function() {
    if (numComplete > 0) {
      ...
      experiment.rainingProbs[currentTrialNum] = parseFloat(document.getElementById("hiddenSliderValue1").value);
    ...
    if (numComplete >= numTrials) {
      ...
      experiment.sentenceTypes[currentTrialNum] = trial.sentenceType;
