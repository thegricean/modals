...
relevant_fields = ["workerid", "Answer.gender", "Answer.age", "Answer.income", "Answer.nativeLanguage", "Answer.orders", "Answer.sentenceTypes", "Answer.rainingProbs", "Answer.evidenceRatings"]
relevant_indices = []
