...
setwd("~/Documents/git/cocolab/modals/experiments/creature_comprehension_2/Submiterator-master")

d = read.table("creature-comprehension-trials-processed.tsv",sep="\t",header=T)
head(d)
...
d[d$response=="e4",]$evidence_type = paste(d[d$response=="e4",]$choice4)
